...
Fontific gives you a really simple way to use fonts from [Google Web Font library](http://www.google.com/webfonts "Google Web Font library") on your Wordpress-powered website. 
